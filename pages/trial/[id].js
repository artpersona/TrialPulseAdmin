...
export default function IndividualTrial(second) {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.trial__container}>
        <h7 className={styles.trial__title}>AZ-ID 1</h7>
        <a className={styles.trial__subtitle}>Astrazeneca</a>
      </div>
        ...
        <div className={styles.panel__content}>
          <div className={styles.panel__wrapper}>
            <div className={styles.radio__container}>
              <p className={styles.radio__label}>
                Require that signees sign the documents in sequence
              </p>
            ...
            <div className={styles.radio__container}>
              <p className={styles.radio__label}>
                Biometric patient verification enabled
              </p>
              <div key={`inline-radio`} className="mb-3">
                <Form.Check
                  inline
            ...
            <div className={styles.radio__container}>
              <p className={styles.radio__label}>
                Redacted Names and Signatures in Sponsors View
              </p>
              <div key={`inline-radio`} className="mb-3">
                <Form.Check
                  inline
