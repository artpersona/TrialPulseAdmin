...
export default function Home() {
  ...
  const { chatrooms, fetchMessages, selectedChatroom, getSpecificChatroom, selectedChatroomUser } = useMessageContext();
  ...
  return (
    <div className={styles.container}>
      ...
      <div className="vh-100" style={{display: 'flex'}}>
        ...
        <div className='d-flex flex-column justify-content-between border border-2 rounded-3' style={{width: '65%', overflow: 'auto'}}>

          {/* Header */}
          <section className="d-flex p-2 border-bottom border-2" style={{alignItems: 'center'}}>
            {/* Photo */}
            <Image roundedCircle={true} style={{width: '50px', height: '50px'}} src="user.webp" alt='user photo'/>
          ...
          {/* Messages */}
          <section className="flex-grow-1 p-2 border-2 border-secondary" style={{alignItems: 'center', overflow: 'auto'}}>
            {/* Message Instance */}
          ...
          <section>
            <InputGroup className="rounded-3 p-3">
              <Form.Control className='border-primary' as="textarea" aria-label="With textarea" />
              <Button>
                Send
              </Button>
            </InputGroup>
